...
public class BasketBallShooter : Agent
{
    ...
    {
        AddVectorObs(basket.localPosition.x - ball.transform.localPosition.x);//relative x
        AddVectorObs(basket.localPosition.z - ball.transform.localPosition.z);//relative z
        AddVectorObs(basket.localPosition.y - ball.transform.localPosition.y);//relative y
